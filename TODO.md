...
- [x] Zobrazení výsledku po dokončení lekce.
- [x] Přidání tlačítka „Nová lekce“.
- [x] Reset lekce.
- [x] Rozdělení JavaScriptu do menších funkcí.
- [x] Přidání funkce `vyberNahodnyText()`.
- [x] Náhodné pochvaly Eurky.
